...
const SHOP_TITLES = [
  ...
  // ── SAISON 2 ──────────────────────────────────────
  { id: 'catarina', name: '👸 CATARINA LA GOAT ✨', price: 0, type: 'title', hidden: true },
  ...
  { id: 'badge_pomels', name: 'Badge Pomels 💰', price: 10000, type: 'badge', emoji: '💰', hidden: true },
  // ── BANNIÈRES ──────────────────────────────────────
  // Couleurs unies
  ...
  // ── SAISON 3 ──────────────────────────────────────
  { id: 'encore_et_toujours', name: 'Encore et toujours là', price: 1000000, type: 'title' },
  { id: 'combattant_saison3', name: '⚔️ Compattant/e de la Saison 3', price: 30000, type: 'title' },
  ...
  { id: 'fan_erreurs', name: 'Fan des Erreurs de la nature', price: 25000, type: 'title' },
  { id: 'fan_destructeur', name: 'Fan des _Xx-oo-Destructeur-oo-xX_', price: 25000, type: 'title' },
  { id: 'fan_brigade', name: 'Fan de la Brigade du Chaos', price: 25000, type: 'title' },
  { id: 'fan_souyette', name: 'Fan de Souyette', price: 25000, type: 'title' },
  { id: 'boss_jeu', name: '😎 Boss des jeux', price: 30000, type: 'title' },
  { id: 'badge_snake', name: 'Badge Serpent 🐍', price: 10000, type: 'badge', emoji: '🐍' },
  { id: 'badge_2048', name: 'Badge 2048 🔢', price: 10000, type: 'badge', emoji: '🔢' },
  { id: 'badge_clicker', name: 'Badge Clicker 🌱', price: 10000, type: 'badge', emoji: '🌱' },
  { id: 'badge_pokepom', name: 'Badge PokePom 🐾', price: 10000, type: 'badge', emoji: '🐾' },
  { id: 'badge_dino', name: 'Badge Dino 🦕', price: 10000, type: 'badge', emoji: '🦕' },
  { id: 'badge_tetris', name: 'Badge Tetris 🧱', price: 10000, type: 'badge', emoji: '🧱' },
  // Titres animés
  ...
  { id: 'phoenix', name: '🔥 Effet Phénix', price: 75000, type: 'color', desc: 'Ton pseudo renaît dans les flammes, braise → or → blanc incandescent !' },
  { id: 'crystal', name: '💎 Effet Cristal', price: 75000, type: 'color', desc: 'Reflets prismatiques holographiques traversant ton pseudo' },
  // Effets animés
  ...
  { id: 'banner_foudre', name: '⛈️ Effet Foudre', price: 100000, type: 'banner', bannerClass: 'banner-foudre', desc: 'Des éclairs violets zèbrent ta carte de façon imprévisible !' },
  { id: 'banner_ocean',  name: '🌊 Effet Océan Profond', price: 100000, type: 'banner', bannerClass: 'banner-ocean',  desc: 'Vagues bioluminescentes qui ondulent dans les abysses' },

  // ── BATTLE PASS ALL STAR ──────────────────────────
  // Items exclusifs débloqués par les paliers du Battle Pass. price: 0 et
  // hidden: true → invisibles dans la boutique (ne peuvent être obtenus que
  // par le Battle Pass). Mais reconnus par le système d'équipement.
  // Titres (paliers 5, 10, 15... 100) — 20 titres
  { id: 'bp_apprenti',     name: '🌟 Apprenti All Star',      price: 0, type: 'title', hidden: true, bpPalier: 5 },
  { id: 'bp_recrue',       name: '🌟 Recrue All Star',        price: 0, type: 'title', hidden: true, bpPalier: 10 },
  { id: 'bp_disciple',     name: '🌟 Disciple All Star',      price: 0, type: 'title', hidden: true, bpPalier: 15 },
  { id: 'bp_guerrier',     name: '🌟 Guerrier All Star',      price: 0, type: 'title', hidden: true, bpPalier: 20 },
  { id: 'bp_combattant',   name: '🌟 Combattant All Star',    price: 0, type: 'title', hidden: true, bpPalier: 25 },
  { id: 'bp_vetérain',     name: '🌟 Vétéran All Star',       price: 0, type: 'title', hidden: true, bpPalier: 30 },
  { id: 'bp_aventurier',   name: '🌟 Aventurier All Star',    price: 0, type: 'title', hidden: true, bpPalier: 35 },
  { id: 'bp_chasseur',     name: '🌟 Chasseur All Star',      price: 0, type: 'title', hidden: true, bpPalier: 40 },
  { id: 'bp_chevalier',    name: '🌟 Chevalier All Star',     price: 0, type: 'title', hidden: true, bpPalier: 45 },
  { id: 'bp_champion',     name: '🌟 Champion All Star',      price: 0, type: 'title', hidden: true, bpPalier: 50 },
  { id: 'bp_elite',        name: '🌟 Élite All Star',         price: 0, type: 'title', hidden: true, bpPalier: 55 },
  { id: 'bp_virtuose',     name: '🌟 Virtuose All Star',      price: 0, type: 'title', hidden: true, bpPalier: 60 },
  { id: 'bp_maître',       name: '🌟 Maître All Star',        price: 0, type: 'title', hidden: true, bpPalier: 65 },
  { id: 'bp_seigneur',     name: '🌟 Seigneur All Star',      price: 0, type: 'title', hidden: true, bpPalier: 70 },
  { id: 'bp_héros',        name: '🌟 Héros All Star',         price: 0, type: 'title', hidden: true, bpPalier: 75 },
  { id: 'bp_titan',        name: '🌟 Titan All Star',         price: 0, type: 'title', hidden: true, bpPalier: 80 },
  { id: 'bp_legende',      name: '🌟 Légende All Star',       price: 0, type: 'title', hidden: true, bpPalier: 85 },
  { id: 'bp_mythique',     name: '🌟 Mythique All Star',      price: 0, type: 'title', hidden: true, bpPalier: 90 },
  { id: 'bp_immortel',     name: '🌟 Immortel All Star',      price: 0, type: 'title', hidden: true, bpPalier: 95 },
  { id: 'bp_grand_maitre', name: '👑 Grand Maître All Star',  price: 0, type: 'title', hidden: true, bpPalier: 100 },
  // Effets profil (paliers 10, 20... 100) — 10 effets : mélange bannières + effets pseudo
  { id: 'bp_effect_spark',   name: '✨ Étincelle (BP)',  price: 0, type: 'banner', bannerClass: 'banner-bp-spark',   hidden: true, bpPalier: 10,  desc: 'Étincelles dorées qui pétillent autour de ta carte' },
  { id: 'bp_effect_flame',   name: '🔥 Flamme (BP)',     price: 0, type: 'color',  hidden: true, bpPalier: 20,  desc: 'Pseudo en gradient ardent orange→rouge' },
  { id: 'bp_effect_wave',    name: '🌊 Vague (BP)',      price: 0, type: 'color',  hidden: true, bpPalier: 30,  desc: 'Pseudo qui ondule en bleu profond' },
  { id: 'bp_effect_thunder', name: '⚡ Tonnerre (BP)',   price: 0, type: 'color',  hidden: true, bpPalier: 40,  desc: 'Pseudo électrique violet/jaune' },
  { id: 'bp_effect_aurora',  name: '🌌 Aurore (BP)',     price: 0, type: 'banner', bannerClass: 'banner-bp-aurora',  hidden: true, bpPalier: 50,  desc: 'Voile d\'aurore boréale animé' },
  { id: 'bp_effect_prism',   name: '💎 Prisme (BP)',     price: 0, type: 'color',  hidden: true, bpPalier: 60,  desc: 'Pseudo cristallin aux reflets prismatiques' },
  { id: 'bp_effect_galaxy',  name: '🌠 Galaxie (BP)',    price: 0, type: 'banner', bannerClass: 'banner-bp-galaxy',  hidden: true, bpPalier: 70,  desc: 'Galaxie spirale en arrière-plan' },
  { id: 'bp_effect_inferno', name: '🌋 Inferno (BP)',    price: 0, type: 'color',  hidden: true, bpPalier: 80,  desc: 'Pseudo en fusion incandescente' },
  { id: 'bp_effect_cosmos',  name: '🪐 Cosmos (BP)',     price: 0, type: 'banner', bannerClass: 'banner-bp-cosmos',  hidden: true, bpPalier: 90,  desc: 'Planètes lointaines dérivant dans l\'espace' },
  { id: 'bp_effect_allstar', name: '👑 All Star (BP)',   price: 0, type: 'banner', bannerClass: 'banner-bp-allstar', hidden: true, bpPalier: 100, desc: 'L\'effet ultime — gradient signature avec étoiles' },
];
